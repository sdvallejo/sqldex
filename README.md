...
| Lint rules | 61 of them, in six groups — see below |
...
Sixty-one of them, in six groups that say what a rule is *about* — which is what someone
...
```
npm test                        # 772 tests, hand-written fixtures only
npm run typecheck
